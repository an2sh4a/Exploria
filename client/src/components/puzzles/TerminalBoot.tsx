...
export default function TerminalBoot({
  ...
  function getStatus() {
    if (progress < 20)
      return "Initializing Security Terminal...";

    if (progress < 40)
      return "Loading Secure Kernel...";

    if (progress < 60)
      return "Authenticating Administrator...";

    if (progress < 80)
      return "Reading Server Logs...";

    if (progress < 100)
      return "Decrypting Security Records...";
